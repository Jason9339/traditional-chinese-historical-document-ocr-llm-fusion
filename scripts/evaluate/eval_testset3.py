...
Dataset: 185 real historical manuscript samples from HuggingFace
"""
...
def main():
    parser = argparse.ArgumentParser(description='Test Set 3: Historical Documents Evaluation')
    ...
    print("=" * 80)
    print("Test Set 3: Historical Documents")
    print("=" * 80)
